			...
			<div>
				<div className={[s.container, s.fon2].join(' ')}>
					<div className={s.foother2}>
						...
						<p>
							Communicating in the chat and on football forums there you will
							find new friends.
							<br />
							The consultant team will help you to go through a difficult path
							from the <br />
			...
			<div>
				<div className={[s.container, s.fon3].join(' ')}>
					<div className={s.foother2}>
						...
						<p>
							We launch a new project in which you have tried to collect all the
							best that is <br />
							in the browser games of the category "Virtual Football Manager".
							IT Football is an <br />
							offline game. The new European Championship opens every season, so
							newbies have a <br />
							chance to pass from creating a team to the championship title, you
							can choose a form, <br />
							stadium, buy players and so on. We are waiting for you in the
